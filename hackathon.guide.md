...
A normal hackathon is a place for multiple people to get together and work on a project that they will present at the end of the hackathon. Instead, our hackathon tries to marry this learning principle with an air of competition - it's the perfect balance between a hackathon and a programming contest: all of the the fun with none of the pressure!

### Positive energy

Hackathons have gotten a bad rap because of _some_ that have an unhealthy, competitive structure, and for setting unrealistic expectations. However, we don't want to run a hackathon like that. We know that everyone's coming in with a different skill set, and the goal should not be to be the first to the finish line as an individual, but to make sure everyone gets to the finish line. Here are the goals I keep in mind:
...
You shouldn't expect to have actually solved the entire problem by the end of the hackathon, and that's okay. Real life problems are hard, and you're experimenting in an area that some people devote their entire lives to as cybersecurity professionals! Instead, think of the hackathon as a pit-stop on a long journey to solve problems or as a training session to prepare yourself for solving problems.

Since you’re not going to solve a problem, we don't want to put unrealistic (and unhealthy) pressure on you. Don’t stay up all night preparing, don’t pump participants with caffeine, and don’t make winners and losers. Just don’t. There has never been beer, competitions, or time pressure at my hackathons. Participants should come energized and be greeted with positive energy.
